...
ARCH = [
    ...
    "pointer_generator_rotary_transformer",
    "rotary_transformer",
    "soft_attention_gru",
    "soft_attention_gru_projection",
    "soft_attention_lstm",
    "soft_attention_lstm_projection",
