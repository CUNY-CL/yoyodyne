...
class Collator:
    ...
    def pad_source(self, itemlist: List[datasets.Item]) -> batch.PaddedTensor:
        """Pads source.
    ...
    def pad_target(self, itemlist: List[datasets.Item]) -> batch.PaddedTensor:
        """Pads target.
    ...
    def __call__(self, itemlist: List[datasets.Item]) -> batch.PaddedBatch:
